    ...
    <form action ="/member/signUp" method = "POST" name = "signUpFrm" id = "signUpFrm">
      ...
      <div class="membership">
        ...
        <div>
          ...
          <input type="password" placeholder="비밀번호를 입력해 주세요." name = "memberPw" id = "memberPw">
        </div>
        ...
        <div>
          ...
          <input type="text" placeholder="닉네임을 입력해주세요" name = "memberNickname" id = "memberNickname">
          <p class="signUp-message" id="nickMessage">한글, 영어, 숫자 2~10자 사이로 입력해 주세요.</p>
        </div>
        ...
        <div>
          ...
          <div>
            <input type="text" placeholder="숫자만 입력해주세요" name = "memberTel" id = "memberTel">
            <button type="button" class="findInfo-btn" id="sendSmsBtn">인증번호 받기</button>
          </div>
          <p class="signUp-message" id="telMessage">연락처(휴대전화)를 입력해 주세요.</p>
      ...
      <main class="main-container">
        ...
        <div class="signUp-main-title2">이용 약관</div>
        <hr class="signUp-hr">
      ...
      <button class="signUp-last-btn">가입하기</button>
