        ...
        <div class="agree-container">
          ...
          <div class="agree-column">
            <div class="checkbox-container">
              <input type="checkbox" id="Allagreement" onchange="toggleAllAgree()">
            ...
            <div class="agree-terms">
              ...
              <h3>제1조 (목적)</h3>
              <p>
                본 약관은 BongGuu 서비스(이하 "서비스")에 가입한 회원이 위드기어 (이하 "회사")가 제공하는 서비스를
              ...
              <ol>
                <li>
                  <strong>BongGuu 서비스</strong>: 단말기(모바일, 태블릿 PC 등의 장치를 포함)를 이용하는 "회원"이 광고물의
                ...
                <li>
                  <strong>BongGuu 회원</strong>(이하, "회원"): 본 약관에 동의 후 이용계약을 체결하고, 서비스에 정상적으로
                  가입되어 "서비스"를 이용하는 고객을 의미합니다.
                </li>
                <li>
                  <strong>BongGuu 계정(ID)</strong>: 회원의 식별과 서비스 이용을 위하여 회원이 가입시 입력한 정보(이메일
                  등)를 기반으로 생성된 고유 ID를 의미합니다.
                </li>
                <li>
                  <strong>포인트</strong>: 회원이 회사가 정한 규정에 따라 BongGuu에서 현금 환급 등이 가능한 포인트를
                  말하며 재화로서의 가치는 없습니다.
                </li>
              </ol>
              ...
              <ol>
                <li>
                  본 약관은 "BongGuu" 최초 회원 가입 시에 공지되며 이에 대하여 "회원"이 동의함으로써 효력이 발생합니다.
                  만약, 동 약관에 동의하지 않으시면 회원 가입을 중단하시면 됩니다. 이 경우 "BongGuu"의 서비스를 더 이상
                  사용하실 수 없습니다. "회사"는 이 약관의 내용을 "회원"이 쉽게 알 수 있도록 BongGuu 서비스 내 초기화면
                  하단에 상시 게시합니다.
                </li>
                <li>
                ...
                <li>
                  ...
                  "BongGuu" 공지사항에 게시하거나, 이메일 또는 문자 서비스를 통하여 "회원"에게 개별적으로 통지합니다.
                ...
                <li>
                  ...
                  거부의사를 표시하지 아니하거나 본 "BongGuu"를 계속 사용할 경우, "회원"이 개정약관에 동의한 것으로 봅니다.
                </li>
                <li>
              ...
              <p>
                ...
                "BongGuu"의 운영 정책 등의 규정에 의합니다.
              </p>

              <h3>제5조 (이용계약 성립 및 승낙)</h3>
              <ol>
                <li>
                  이용계약은 만 14세 이상인 "회원"이 본 "BongGuu" 가입 과정 상의 본 약관이 명시된 창에서 '동의' 버튼을 누르면
                ...
                <li>
                  "회사"는 "가입신청자"의 신청에 대하여 "BongGuu" 이용을 승낙함을 원칙으로 하며, 이용계약은 "회원"의
                  "BongGuu" 신청에 대하여 "회사"가 승낙함으로써 성립됩니다.
                </li>
              </ol>
              ...
              <ol>
                <li>
                  ...
                  <ol type="a">
                    <li>
                      "회원"이 소지한 단말기가 본 "BongGuu"를 지원하지 않는 등 기술상 "BongGuu" 제공이 불가능 한 경우 또는
                      "BongGuu" 관련 설비의 여유가 없거나 업무 상 문제가 있는 경우
                    </li>
                    <li>
                ...
                <li>
                  "회사"는 "회원"에 대해 "회사"정책에 따라 등급별로 구분하여 이용시간, 이용횟수, "BongGuu" 메뉴 등을 세분하여 이용에
                  차등을 둘 수 있습니다.
                </li>
                <li>
              ...
              <ol>
                <li>
                  "회원"은 "BongGuu"내 "정보수정" 화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만,
                  "BongGuu" 관리를 위해 필요한 ID, 닉네임 등은 수정이 불가능합니다.
                </li>
                <li>
              ...
              <ol>
                <li>
                  "회원"은 언제든지 "BongGuu" 내 "회원 탈퇴" 메뉴를 통하여 이용계약 해지 신청을 할 수 있으며, "회사"는 관련법 등이
                ...
                <li>
                  "회사"는 "회원"이 약관의 의무를 위반하거나 "BongGuu"의 정상적인 운영을 방해한 경우, 경고, 일시정지, 영구이용정지 등으로
                  "BongGuu" 이용을 단계적으로 제한할 수 있습니다.
                </li>
                <li>
                  ...
                  영구이용정지를 할 수 있습니다. 본 항에 따른 영구이용정지시 "BongGuu" 이용을 통해 획득한 혜택 등도 모두 소멸되며,
              ...
              <ol>
                <li>
                  회사는 서비스 사이트를 통하여 회원에 대한 BongGuu 관련 제반 서비스 및 정보의 제공, 기타 회사가 정하는 업무를 수행합니다.
                </li>
                <li>
              ...
              <ol>
                ...
                <li>
                  본 조 제1항의 사유로 서비스를 중단하고자 할 경우 회사는 BongGuu 서비스 내 공지사항을 통하여 회원에게 서비스 중단사실을 알려드립니다.
                </li>
                <li>
              ...
              <ol>
                <li>
                  BongGuu 서비스에서 요구하는 광고물의 제작 또는 광고 게시 및 요청 액션이 완료되면 포인트를 부여받게 됩니다. 포인트 적립을 위하여
              ...
              <ol>
                <li>
                  가용포인트는 BongGuu 서비스에 등록된 회사가 제공하는 제휴한 컨텐츠(상품) 구매 시 또는 현금 환급 시 사용할 수 있으며 해당 바코드
              ...
              <ol>
                ...
                <li>
                  ...
                  의견이나 불만사항에 대해서는 BongGuu 서비스 내 공지사항을 활용하거나 이메일 등 개별적으로 "회원"에게 처리과정 및 결과를 전달합니다.
                </li>
              </ol>
              <h3>제 17 조 (회원의 의무)</h3>
              ...
              <h3>제 21 조 (책임제한)</h3>
              <ol>
                <li>“회사”는 천재지변 또는 이에 준하는 불가항력으로 인하여 “BongGuu” 서비스를 제공할 수 없는 경우에는 “BongGuu” 서비스 제공에 관한 책임이 면제됩니다.</li>
                <li>“회사”는 “회원”의 귀책사유로 인한 “BongGuu” 이용의 장애에 대하여는 책임을 지지 않습니다.</li>
                <li>“회사”는 “회원”이 “BongGuu”와 관련하여 게재한 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여는 책임을 지지 않습니다.</li>
                <li>“회사”는 “회원” 간 또는 “회원”과 제3자 상호간에 “BongGuu”을 매개로 하여 거래 등을 한 경우에는 책임이 면제됩니다.</li>
                <li>“회사”는 무료로 제공되는 “BongGuu” 이용과 관련하여 관련법에 특별한 규정이 없는 한 책임을 지지 않습니다.</li>
                <li>“회사”는 제3자가 “BongGuu”내 화면 또는 링크된 웹사이트를 통하여 광고한 제품의 내용과 품질에 대하여 감시할 의무 등 기타 어떠한 책임도 지지 아니합니다.</li>
                <li>“회사”및 “회사”의 임직원 그리고 대리인은 다음과 같은 사항으로부터 발생하는 손해에 대해 책임을 지지 아니합니다.
                  <ol type="1">
                    <li>“회원” 상태정보의 허위 또는 부정확성에 기인하는 손해</li>
                    <li>그 성질과 경위를 불문하고 “BongGuu”에 대한 접속 및 “BongGuu”의 이용과정에서 발생하는 개인적인 손해</li>
                    ...
                    <li>제3자가 “BongGuu”를 이용하여 불법적으로 전송, 유포하거나 또는 전송, 유포 되도록 한 모든 바이러스, 스파이웨어 및 기타 악성 프로그램으로 인한 손해</li>
                    <li>전송된 데이터의 오류 및 생략, 누락, 파괴 등으로 발생되는 손해</li>
                    <li>“회원”간의 “BongGuu” 이용 과정에서 발생하는 명예훼손 기타 불법행위로 인한 각종 민형사상 책임</li>
                  </ol>
                </li>
              </ol>
              ...
              <p>회사는 관련법령이 정하는 바에 따라서 회원 등록정보를 포함한 회원의 개인정보를 보호하기 위하여 노력합니다. 회원의 개인정보보호에 관해서는 관련법령 및 회사가 정하는 "개인정보 취급방침"에 정한 바에 의하며, 회원이 상시 확인할 수 있도록 BongGuu 서비스 내에서 공지하고 있습니다.</p>
            </div>

            <div class="checkbox-container">
              <input type="checkbox" id="Serviceagreement" onchange="checkIndividualAgreements()">
            ...
            <div class="checkbox-container">
              <input type="checkbox" id="Privacyagreement" onchange="checkIndividualAgreements()">
