...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/board/notification/notificationUpdate-style.css">
...
<!-- include libraries(bootstrap) -->
	...
	<section id="main-container">
        <div id="title-area">
            <div><h1> 공지사항</h1> <h3>ㅣ 게시글 수정</h3></div>
            <div>득근전수에서 회원님들에게 공지드립니다.</div>
        </div>

        <div id="middle-area">
            <form action="/board/${boardCode}/${boardNo}/update" method="post" id="write-form" 
				>
                ...
                <div id="title-middle-area">
                    ...
                    <textarea name="boardTitle" id="title-textArea" placeholder="">${board.boardTitle}</textarea>
                </div>
	...
	<script src="/resources/js/board/notification/notificationUpdate.js"></script>
