...
<body>
    ...
    <section class="ranking-section">
        <h1>헤더 아이콘 어떻게 할까?? </h1>
    <div class="nav-icon-sample-area">

        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa-solid fa-message fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver1">2</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-cart-shopping fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver1">3</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-magnifying-glass fa-xl" style="color: #99E1ED;"></i>
            </a>
        </div>

        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa-solid fa-message fa-xl" style="color: white;"></i>
                <span class="chatting-count ver1">2</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-cart-shopping fa-xl" style="color: white;"></i>
                <span class="chatting-count ver1">3</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-magnifying-glass fa-xl" style="color: white;"></i>
            </a>
        </div>
        ...
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa-solid fa-message fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver2">2</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-cart-shopping fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver2">3</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
        ...
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa-solid fa-message fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver3">2</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-cart-shopping fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver3">3</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
        ...
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa-solid fa-message fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver4">2</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
                <i class="fa fa-solid fa-cart-shopping fa-xl" style="color: #99E1ED;"></i>
                <span class="chatting-count ver4">3</span>
            </a>
        </div>
        <div class="nav-icon-area">
            <a href="/chatting">
